...
try {
    ...
    if ($clientRunBatchItem.PSIsContainer -or ($clientRunBatchItem.Attributes -band [IO.FileAttributes]::ReparsePoint)) {
        throw "batch client control wrapper is not a regular file: $clientRunBatch"
    }
